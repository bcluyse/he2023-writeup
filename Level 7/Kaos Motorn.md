We get an excel spreadsheet using quite a lot of operations to generate a string in the middle. It seems quite some values are calculated, some are input and some are just 'garbage' (the date values). 
